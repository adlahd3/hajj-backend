...
class RetailersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create retailer" do
    assert_difference('Retailer.count') do
      post retailers_url, params: { retailer: { cr: @retailer.cr, name: @retailer.name } }, as: :json
    end
  ...
  test "should update retailer" do
    patch retailer_url(@retailer), params: { retailer: { cr: @retailer.cr, name: @retailer.name } }, as: :json
    assert_response 200
  end
